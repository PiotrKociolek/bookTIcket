...
{
    public class DeleteUserHandler : BaseHandler<DeleteUser, Unit>
    {
        ...
        public override async Task<Unit> Handle(DeleteUser request, CancellationToken cancellationToken)
        {
